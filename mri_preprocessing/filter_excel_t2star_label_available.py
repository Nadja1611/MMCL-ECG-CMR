...
def extract_labels_and_filter(data_dir, df):
    labels = []
    patient_names = []
...
patients_data, patient_names, error_count = generate_tensors_and_labels_t2star(data_dir)

# Extract the labels and filter the DataFrame based on the conditions
filtered_df, labels = extract_labels_and_filter(data_dir, df)
...
filtered_excel_file = '/Users/nadjagruber/Documents/ECG_MRI_Project/filtered_marinastemi_label_and_t2star_available.xlsx'
