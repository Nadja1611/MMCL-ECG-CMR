...
#SBATCH --output=/gpfs/data/fs72515/nadja_g/ECGMRIProjekt/logs/output_%j.out   # Standard output file (with unique job ID)
#SBATCH --error=/gpfs/data/fs72515/nadja_g/ECGMRIProjekt/logs/error_%j.err  
